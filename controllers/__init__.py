...
from .UtilsController import utils_bp
# Список всех blueprints
blueprints = [employee_bp, login_bp, users_bp, task_journal_bp, resources_bp, missions_bp, reports_journal_bp, experiment_journal_bp, completed_tasks_bp, utils_bp]